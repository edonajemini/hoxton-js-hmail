...
const state: State = {
  emails: [
    ...
    {
      from: 'Edona Jemini',
      header: 'Heyy, how are you?!',
      content:
        'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci quo et assumenda voluptas blanditiis incidunt quia in, accusamus, qui voluptatem porro. Est reiciendis cum a architecto earum voluptatibus vel atque.',
      emailAddress: 'edona@email.com',
      img: 'assets/js.jpeg',
      read: false
    },
